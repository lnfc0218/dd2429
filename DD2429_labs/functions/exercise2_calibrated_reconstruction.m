...
% norm_cameras(:,:,1)=norm_mat(:,:,1)*cameras(:,:,1);
% norm_cameras(:,:,2)=norm_mat(:,:,2)*cameras(:,:,2);
% norm_points2d(:,:,1)=norm_mat(:,:,1)*points2d(:,:,1);
% norm_points2d(:,:,2)=norm_mat(:,:,2)*points2d(:,:,2);
% points3d = reconstruct_point_cloud( norm_cameras, norm_points2d );
